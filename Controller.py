...
from Version1.Model import Model, human_bytes
import threading
import time
...
class Controller:
    ...
    def start_scan_thread(self):
        ...
        self.model = Model(block_size=scan_params.block_size,
                           path=scan_params.path,
                           is_fast_mode=scan_params.is_fast,
                           min_size=scan_params.min_size)
