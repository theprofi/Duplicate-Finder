...
from Version2.View import View
from Version2.Model import Model, BLOCK_SIZE_IDX, PATH_IDX, IS_FAST_IDX, MIN_SIZE_IDX
import threading
import time
...
class Controller:
    ...
    def update_gui(self):
        def update_gui_thread():
            ...
            for i, grp in enumerate(scan_results.duplicates):
                self.view.add_group(grp=grp[0], size=grp[1], grp_idx=i)
